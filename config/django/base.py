...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://django:django@127.0.0.1:5432/main'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'main.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'main.api.exception_handlers.hacksoft_proposed_exception_handler',
